    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status == 'success') {
            (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " updated successfully!"));
          }
          _context.next = 11;
          break;
        case 8:
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var stripe = Stripe('pk_test_51Q5B3KRuS7dWOMLlLq5uRQ2dYviioMQ9Il80orfAS49KCw30sf92xR2vwI6lnYjzxGHRxALbtleNWjzHTm0YvVS300KnvpGV2C');
  if (bookBtn) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              console.log('Error while booking the tour:', _context.t0);
